...
**Audited production path:** `panel.py` → `stark-solarpower-panel-bundle.js?v=0.6.6` → `stark-solarpower-panel`
**Scope:** implemented in UI v0.6.6; phone field acceptance remains required
...
| Production delivery | PASS | `panel.py` uses one cache-busted autonomous bundle URL and UI version `0.6.6`. |
