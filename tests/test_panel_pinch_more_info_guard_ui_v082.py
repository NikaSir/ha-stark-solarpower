...
class PanelPinchMoreInfoGuardUiV082Tests(unittest.TestCase):
    ...
    def test_delivery_versions_and_bundle_source_agree(self) -> None:
        self.assertEqual(self.integration_manifest["version"], "1.8.28")
        self.assertEqual(self.panel_manifest["ui_version"], "0.8.6")
        self.assertIn('PANEL_UI_VERSION = "0.8.6"', self.panel_registration)
